...
pub mod test {
    ...
    pub const ENUM_VALUES_TEST_UNION: [TestUnion; 3] =
        [TestUnion::NONE, TestUnion::A, TestUnion::B];
    ...
    impl TestUnion {
        ...
        pub const ENUM_VALUES: &'static [Self] = &[Self::NONE, Self::A, Self::B];
    ...
    impl<'a> NestingTest<'a> {
        ...
        pub fn c(&self) -> Option<Test<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<Test>>(NestingTest::VT_C, None)
            }
        }
    }
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> NestingTestBuilder<'a, 'b, A> {
        ...
        pub fn add_c(&mut self, c: flatbuffers::WIPOffset<Test<'b>>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<Test>>(NestingTest::VT_C, c);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> NestingTestBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
            NestingTestBuilder {
                fbb_: _fbb,
                start_: start,
        ...
        pub fn b(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Test<'a>>>> {
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Test>>,
                >>(ListTest::VT_B, None)
            }
        }
    }
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                ...
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Test>>,
                >>("b", Self::VT_B, false)?
                .finish();
            Ok(())
        }
    ...
    pub struct ListTestArgs<'a> {
        pub a: i32,
        pub b: Option<
            flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Test<'a>>>>,
        >,
    }
    impl<'a> Default for ListTestArgs<'a> {
        #[inline]
        fn default() -> Self {
            ListTestArgs { a: 0, b: None }
        }
    }
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ListTestBuilder<'a, 'b, A> {
        ...
        pub fn add_b(
            ...
            b: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<Test<'b>>>,
            >,
        ) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(ListTest::VT_B, b);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> ListTestBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
            ListTestBuilder {
                fbb_: _fbb,
                start_: start,
    ...
    impl<'a> UnionTest<'a> {
        ...
        pub fn a_type(&self) -> TestUnion {
            ...
            unsafe {
                self._tab
                    .get::<TestUnion>(UnionTest::VT_A_TYPE, Some(TestUnion::NONE))
                    .unwrap()
            }
        }
        #[inline]
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_union::<TestUnion, _>(
                    ...
                    |key, v, pos| match key {
                        TestUnion::A => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<Test>>(
                                "TestUnion::A",
                                pos,
                            ),
                        TestUnion::B => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<Test2>>(
                                "TestUnion::B",
                                pos,
                            ),
                        _ => Ok(()),
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> UnionTestBuilder<'a, 'b, A> {
        ...
        pub fn add_a_type(&mut self, a_type: TestUnion) {
            self.fbb_
                .push_slot::<TestUnion>(UnionTest::VT_A_TYPE, a_type, TestUnion::NONE);
        }
        #[inline]
        pub fn add_a(&mut self, a: flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(UnionTest::VT_A, a);
        }
        #[inline]
        pub fn add_b(&mut self, b: i32) {
    ...
    #[inline]
    pub fn finish_size_prefixed_test_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(
        fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
        root: flatbuffers::WIPOffset<Test<'a>>,
    ) {
